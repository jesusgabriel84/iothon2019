 ...
 */
#define MQTT_TOPIC_1 "/TUAS/1/people"
#define MQTT_TOPIC_2 "/TUAS/2/people"
#define MQTT_TOPIC_STATE "iothon/myteam/status"
#define MY_SERVER  "195.148.126.70"
/****************************************************/
...
/*    float temperature = 5; */
    mqttPublish(MQTT_TOPIC_1, headcount());
    
    mqttPublish(MQTT_TOPIC_2, headcount());
  }
...
/* This headcount function will generate random numbers */
int headcount() {
